...
public class Project {
	public static void main(String[] args) {
		...
		try {
			File s1File = new File("C:\\Users\\jgibs\\OneDrive - Texas Tech University\\2023 Spring\\Design & Analysis of Algorithms\\Project1\\source1.txt");
			Scanner s1Reader = new Scanner(s1File);
			File s2File = new File("C:\\Users\\jgibs\\OneDrive - Texas Tech University\\2023 Spring\\Design & Analysis of Algorithms\\Project1\\source2.txt");
			Scanner s2Reader = new Scanner(s2File);
			File s3File = new File("C:\\Users\\jgibs\\OneDrive - Texas Tech University\\2023 Spring\\Design & Analysis of Algorithms\\Project1\\source3.txt");
			Scanner s3Reader = new Scanner(s3File);
			File s4File = new File("C:\\Users\\jgibs\\OneDrive - Texas Tech University\\2023 Spring\\Design & Analysis of Algorithms\\Project1\\source4.txt");
			Scanner s4Reader = new Scanner(s4File);
			File s5File = new File("C:\\Users\\jgibs\\OneDrive - Texas Tech University\\2023 Spring\\Design & Analysis of Algorithms\\Project1\\source5.txt");
