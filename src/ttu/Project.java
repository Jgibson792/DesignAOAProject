...
public class Project {
	public static void main(String[] args) {
		...
		M1.sort(s1rearranged, 0, s1rearranged.length-1);	//Sorts the array and counts inversions
		System.out.println(M1.getInversions());			//Displays the # of inversions
		...
		//Displays the rank of the source file based on its reliability(# of inversions)
